 ...
 */
var walking : [String] = ["walking 10 km", "walk 5 km"]
var running : [String] = ["sprint 10 sec", "marathon run"]
...
var challanges = [walking,running]
print(challanges)
print(challanges[0][1])
...
var newChallanges=["making it happen"]
...
if newChallanges.isEmpty {
    ...
    print("The challenge you have chosen is \(newChallanges[0]) ")
}
else{
    print("you have choosen multiple challenges")
}
/*:
