...
var Gaurav = User(Name: "Gaurav Bansal", age: 21, height: 175, weight: 80, activityLevel: 9)
print("User Name \(Gaurav.Name) of age \(Gaurav.age) and height \(Gaurav.height) and weight \(Gaurav.weight) is at activity level \(Gaurav.activityLevel) ")
/*:
...
var soFarDistance = Distance(meter: 1)
print(soFarDistance.meter)
print(soFarDistance.feet)
